...
--
-- Host: localhost    Database: ch26_ecommerce
-- ------------------------------------------------------
...
INSERT INTO `customers` VALUES (1,'Sergio','Torres','Av. Siempre viva','sergio@gmail.com'),(2,'Sergio','Torres','Calle Palmas n.2','torres@gmail.com'),(3,'Ixchel','N','Av. Pencil n.56','ixchel@gmail.com'),(4,'Alexis','MT','Av. Benito Juárez','alexis@gmail.com'),(5,'Berenice','Gudiño','Calle Las Palmas n.45','berenice@gmail.com'),(6,'Nicolas','Walser','4 Priver Drive','nicolas@gmail.com'),(7,'Jessica','Sánchez','Av. Las Águilas n.90','jessica@gmail.com');
...
INSERT INTO `orders` VALUES (1,1,'2023-05-30','2023-06-30'),(2,2,'2023-05-30','2023-07-25'),(3,3,'2023-05-30','2023-06-15'),(4,4,'2023-05-30','2023-08-01'),(5,5,'2023-05-30','2023-09-12');
...
CREATE TABLE `orders_has_products` (
  ...
  CONSTRAINT `fk_order_has_products_orders1` FOREIGN KEY (`orders_order_id`) REFERENCES `orders` (`order_id`),
...
INSERT INTO `orders_has_products` VALUES (1,1,1),(1,15,1),(2,3,1),(2,12,1),(3,5,1),(3,8,1),(4,16,1),(5,1,1),(5,2,1),(5,4,1);
...
CREATE TABLE `products` (
  ...
  KEY `fk_product_has_cateogry_idx` (`category_id`),
...
-- Dump completed on 2023-05-30 17:19:02
